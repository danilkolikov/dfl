...
import Frontend.Inference.Processor (Signatures, TypeSynonymSignatures)
...
data Output = Output
    ...
    , getExpandedTypeSynonyms :: TypeSynonymSignatures -- ^ Get expanded type synonym signatures
    } deriving (Eq, Show)
